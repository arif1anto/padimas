...
Class Mathcaptcha
{
    ...
    public function get_question()
    {
		...
		$this->ci->session->set_userdata('mathcaptcha_answer', $answer);
    ...
    public function check_answer($answer)
    {
        ...
        $mathcaptcha_answer = $this->ci->session->userdata('mathcaptcha_answer');
        if ($mathcaptcha_answer !== FALSE)
        {
			...
			$this->ci->session->unset_userdata('mathcaptcha_answer');
        }
        else
        {
            //Answer not present
