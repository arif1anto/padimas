<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Tes TPA</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Hapus Data TPA Mahasiswa</h3>
                </div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p id="konfirm_text"></p>
		<?php echo form_open('admin/test/resetjwbtpamhs/hapus') ?>
...
<script type="text/javascript">
	function cari(){
		...
		if(nilai!=''){
			$.ajax({
				type: "POST",
				url: "<?php echo base_url().index_page();?>admin/ajax/getCariTesTPA",
	...
	function hapus(id){
		if(id!=null && id!=''){
			$("#konfirm_text").html("Yakin menghapus Jawaban Test TPA no pendaftaran "+id+"  ini?");
			$("#idhapus").val(id);
			$('#konfirm').modal();
		}
	}
