...
<head>
	...
	?>
	<title>Amplop Surat Pengumuman</title>
	...
	<style type="text/css">
		...
		.amplop{margin-top:50px;margin-left:150px;width:500px;text-align:left !important;float:left;}
		.amplop span{font-size:12pt !important;}
		@media print {
	      	.page{
				width: 100%;
		        height: auto;
